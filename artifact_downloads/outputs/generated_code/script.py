...
automl_run_id = 'calm_turtle_jyc80gz19c_6'
...
def generate_data_transformation_config():
    ...
    column_group_1 = ['height', 'weight', 'SMK_stat_type_cd']
    
    column_group_2 = [['waistline'], ['DBP'], ['triglyceride'], ['hemoglobin'], ['serum_creatinine'], ['SGOT_ALT'], ['gamma_GTP']]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://subscriptions/fc14670d-c5e7-4c9f-aaa4-11ab881abb5f/resourcegroups/proyecto1-modulo4/workspaces/proyecto1/datastores/workspaceblobstore/paths/LocalUpload/8b750688943c06f20a256eba1f9c792f/training-table/',     help='Default training dataset uri is populated from the parent run')
    parser.add_argument('--validation_dataset_uri',  type=str, default='azureml://subscriptions/fc14670d-c5e7-4c9f-aaa4-11ab881abb5f/resourcegroups/proyecto1-modulo4/workspaces/proyecto1/datastores/workspaceblobstore/paths/LocalUpload/c15f79aae69b072a696a022d98ab3cc6/validation-table/',     help='Default validation dataset uri is populated from the parent run')
